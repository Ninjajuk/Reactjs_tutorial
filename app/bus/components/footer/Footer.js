...
const Footer1 = () => {
  return (
    <footer aria-labelledby="footer-heading" className="bg-white my-4">
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
          ...
          <div className="relative mt-6 flex items-center py-12 px-6 sm:py-16 sm:px-10 lg:mt-0">
            ...
            <div className="relative mx-auto max-w-sm text-center">
              <h3 className="text-2xl font-bold tracking-tight text-purple-700">Visit our Office</h3>
      ...
      <div className="py-10 md:flex md:items-center md:justify-between">
        <div className="text-center md:text-left">
          <p className="text-sm text-gray-500">&copy; 2024 All Rights Reserved Yingkiong Travels</p>
        </div>

        <div className="mt-4 flex items-center justify-center md:mt-0">
          <p className="text-sm text-gray-500 font-bold">Designed and Coded by <span className='text-purple-700 font-bold text-md'>Samsuddin Ansari</span></p>
