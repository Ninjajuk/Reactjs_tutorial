...
const PayeeDiscountDetails = () => {
  ...
  return (
    <div className="p-4 ">
      <h1 className="text-2xl font-bold mb-4 text-purple-800 leading-5">Payee & Discount Details</h1>

      {/* Payee Details */}
      <div className="mb-4">
        <h2 className="text-lg font-semibold mb-2 text-gray-500">Payee Details</h2>
      ...
      {/* Discount Details */}
      <div>
        <h2 className="text-lg font-semibold mb-2 text-gray-500">Discount Details</h2>
        {/* <div className="flex flex-col space-y-2">
          <div className="flex flex-col">
